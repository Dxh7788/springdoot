...
public class ExtendedBeanInfo implements BeanInfo {
    ...
    private final Set<PropertyDescriptor> propertyDescriptors = new TreeSet<>(new ExtendedBeanInfo.PropertyDescriptorComparator());


    /**
     * Wrap the given {@link BeanInfo} instance; copy all its existing property descriptors
     * locally, wrapping each in a custom {@link org.springframework.beans.ExtendedBeanInfo.SimpleIndexedPropertyDescriptor indexed}
     * or {@link org.springframework.beans.ExtendedBeanInfo.SimplePropertyDescriptor non-indexed} {@code PropertyDescriptor}
        ...
        for (PropertyDescriptor pd : delegate.getPropertyDescriptors()) {
            try {
                this.propertyDescriptors.add(pd instanceof IndexedPropertyDescriptor ?
                        new ExtendedBeanInfo.SimpleIndexedPropertyDescriptor((IndexedPropertyDescriptor) pd) :
                        new ExtendedBeanInfo.SimplePropertyDescriptor(pd));
            }
    ...
    private void handleCandidateWriteMethod(Method method) throws IntrospectionException {
        ...
        if (nParams == 1) {
            if (existingPd == null) {
                this.propertyDescriptors.add(new ExtendedBeanInfo.SimplePropertyDescriptor(propertyName, null, method));
            }
            else {
            ...
            if (existingPd == null) {
                this.propertyDescriptors.add(
                        new ExtendedBeanInfo.SimpleIndexedPropertyDescriptor(propertyName, null, null, null, method));
            }
                ...
                this.propertyDescriptors.add(new ExtendedBeanInfo.SimpleIndexedPropertyDescriptor(
     ...
     * @see org.springframework.beans.ExtendedBeanInfo#propertyDescriptors
     */
